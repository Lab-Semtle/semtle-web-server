...
# 호출할 모듈 추가
from src.api.v1_master.study_board.study_board_dto import ReadBoard, ReadBoardlist, CreateBoard, UpdateBoard
from src.api.v1_master.study_board import study_board_svc
...
async def create_study_board(
    ...
    await study_board_svc.create_study_board(study_board_info, db)
    return SU.CREATED
...
async def update_study_board(
    ...
    await study_board_svc.update_study_board(study_board_no, study_board_info, db)
    return SU.SUCCESS
